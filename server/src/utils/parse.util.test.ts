...
describe("ParseUtil", () => {
  describe("getPage", () => {
    const getPage = (data: string, url: string) => ParseUtil.getPage(data, url);

    describe("title", () => {
      it("should get the title of the page", () => {
        const data = "<html><head><title>Test</title></head></html>";
        const page = getPage(data, "http://www.test.com");
    ...
    describe("externalUrls", () => {
      ...
      it('should ignore hrefs when they start with "mailto:"', () => {
        const data =
          '<body><a href="mailto:test@pinpoint.com">Snail Mail</a></body>';
        const page = getPage(data, "http://www.test.com");
    ...
    describe("tokens", () => {
      ...
      it("should return a list of tokens inside of the body tag", () => {
        const data =
          "<body><h1>Test</h1><span>This word should be Indexed</span></body>";
        const page = getPage(data, "http://www.test.com");
