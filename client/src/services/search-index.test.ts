...
describe('SearchIndex', () => {
    ...
    test('should properly sort pages by title when token counts are equal', () => {
    ...
    test('should return 1 page added when adding a page for the first time', () => {
        const page1 = initPage('1');
        const token = 'apple';
    ...
    test('should return 0 pages added when adding a page for the second time', () => {
        const page1 = initPage('1');
        const token = 'apple';
